...
\begin{frame}
	\begin{itemize}
		\item Donner plusieurs vecteurs égaux au vecteur $\widevec{BC}$ sur la figure ci-dessous : \onslide<2-> {{\color{red}$\widevec{AO}, \widevec{OD}, \widevec{FE}$.}}
		\item Quelle est l'image du point $F$ par la translation de vecteur $\widevec{DC}$ ? \onslide<2-> {{\color{blue}$A$.}}
	\end{itemize}
