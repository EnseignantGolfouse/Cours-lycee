...
\newcommand{\Activite}{
	...
	\begin{center}
		...
		On veut montrer que \squared{$\vec{CA} + \vec{CB} = 2\vec{CM}$}.
	\end{center}
	...
	\begin{enumerate}
		\item Soit $D$ l'image du point $A$ par le vecteur $\vec{CB}$.
		...
		\item Quelle propriété ont les diagonales d'un parallélogramme ? \vspace{1em}
		      ...
		      En déduire que $\vec{CD} = 2\vec{CM}$. \vspace{1em}
		\item Montrer alors que $\vec{CA} + \vec{CB} = 2\vec{CM}$.
	\end{enumerate}
}
