...
\begin{vocabulaire}
	...
	Si une translation de vecteur $\vec{u}$ envoie le point A sur le point B, on peut appeler le vecteur de cette translation \squareFrame{$\vec{AB}$}. On dit alors que $\vec{AB}$ est un \textbf{représentant} de $\vec{u}$.
\end{vocabulaire}
