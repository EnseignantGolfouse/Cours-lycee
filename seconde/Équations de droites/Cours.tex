...
\begin{propriete}
	\begin{itemize}
		\item Si $a$ , $b$ et $c$ sont des nombres réels, $\begin{pmatrix}-b \\ a\end{pmatrix}$ est un vecteur directeur de la droite définie par $ax + by + c = 0$.
		\item Inversement, si $(d)$ est une droite dont $\begin{pmatrix}-b \\ a\end{pmatrix}$ est un vecteur directeur, on peut trouver $c ∈ ℝ$ tel que $ax + by + c = 0$ est une équation cartésienne de $(d)$.
	\end{itemize}
\end{propriete}
