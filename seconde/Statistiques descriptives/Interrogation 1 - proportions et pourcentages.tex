...
\begin{exercice}
	...
	\begin{enumerate}
		\item Donner la proportion de croix dans la population ci-dessus : \correctionDots{$\dfrac{11}{17}$}
		\item Si l'image était en couleur, on verrait que la proportion de cercles bleus \textbf{parmi les cercles} est de $\dfrac{2}{3}$. Quelle est alors la proportion de cercles bleus dans la population globale ? \correctionDots{$\dfrac{2}{3} × \dfrac{6}{17} = \dfrac{4}{17}$}
	\end{enumerate}
\end{exercice}
...
\begin{exercice}
	Calculer les évolutions suivantes :
	\begin{enumerate}
		\item $100$ augmenté de $90\%$ : \correctionDots{$190$}
		\item $80$ augmenté de $30\%$ : \correctionDots{$104$}
		\item $160$ diminué de $25\%$ : \correctionDots{$120$}
		\item $16$ augmenté de $150\%$, puis diminué de $60\%$ : \correctionDots{$12$}
	\end{enumerate}
\end{exercice}
