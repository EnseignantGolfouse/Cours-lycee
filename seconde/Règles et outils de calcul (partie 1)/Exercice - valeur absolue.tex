\documentclass[
	classe=$2^{de}$,
	headerTitle=Exercices\space-\space valeur\space absolue
]{exercice}
...
\begin{exercice}
	...
	\begin{minipage}{0.45\linewidth}
		\begin{center}
			...
			\circled{3}\begin{tikzpicture}[scale=2]
	...
	\begin{minipage}{0.45\linewidth}
		\begin{center}
			...
			\circled{4}\begin{tikzpicture}[scale=0.4]
