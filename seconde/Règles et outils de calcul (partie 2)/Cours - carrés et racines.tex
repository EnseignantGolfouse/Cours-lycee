...
\newcommand{\Cours}{
	...
	\begin{greybox}
		...
		\begin{itemize}
			\item \correction{$\sqrt{9×16} = \sqrt{144} = 12$,\hspace{1em} et \hspace{1em}$\sqrt{9}×\sqrt{16}=3×4=12$}\vspace{1em}
			\item \correction{$\sqrt{\dfrac{9}{16}} = \sqrt{0,5625} = 0,75$,\hspace{1em} et \hspace{1em}$\dfrac{\sqrt{9}}{\sqrt{16}} = \dfrac{3}{4} = 0,75$}\vspace{1em}
			\item \correction{$\sqrt{16 + 9} = \sqrt{25} = 5$,\hspace{1em} et \hspace{1em}$\sqrt{16} + \sqrt{9}=4 + 3=7$}\vspace{1em}
		\end{itemize}
	\end{greybox}
}
