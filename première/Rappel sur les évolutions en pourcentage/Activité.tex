...
\TitreDActivite{Activité \textbf{Chapitre 1}}{Proportionnalité et pourcentages}{1STI2D}
...
\begin{minipage}{0.47\textwidth}
	...
	\begin{tabularx}{\linewidth}{|X|}
		\hline
		\textbf{Bilan} : pour augmenter un nombre de $8\%$, \\ il suffit de \\ \dotfill
		\\ \hline
	\end{tabularx}
\end{minipage}
\hfill\vline\hfill
\begin{minipage}{0.45\textwidth}
	...
	\begin{tabularx}{\linewidth}{|X|}
		\hline
		\textbf{Bilan} : pour diminuer un nombre de $15\%$, \\ il suffit de \\ \dotfill
		\\ \hline
	\end{tabularx}
\end{minipage}
